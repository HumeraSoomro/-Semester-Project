...
public class Restaurant {
    ...
    public void placeOrder(String item, Scanner scanner) {
        ...
        if (index != -1) {
            System.out.println("\t\t\tYou are placing an order for " + menuItems.get(index) + " at " + name + ".Enter the quantity.");
            ...
            while (true) {
                ...
                if (!confirmation.isEmpty()) { 
                    ...
                    if (choice == 'y' || choice == 'Y') {
                        System.out.println("\t\t\tPlacing order for " + menuItems.get(index) + " at " + name + ". Enjoy your meal!");
                        break;
            ...
            System.out.println("\t\t\tSorry, " + item + " is not available on the menu of " + name + ".");
        }
    }
